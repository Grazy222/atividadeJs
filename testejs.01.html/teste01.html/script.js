...
//console.log {numero == 5}//false,pq o valor que esta guardado não é 5.
//console.log {nuemro ==2}//true,pq o valor que esta
guardado é 2.

//verificação de tipo e valor
console.log{number === 2}//true,pq o valor e o tipo são verdadeiros.

console.log{nuemro === "familia"}

console.lo{numero == '2'}

// !=
let verificar = "feijão"
//console.log{verificar != "arroz"}
//true,pq é verdade que eles são diferentes.

//!==

let diferente = `vou ficar rica`
console.log{diferente !==472}//true,pq o valor e o tipo são 
diferentes

//console.log{diferente !== 'vou ficar rica'}

//FUNÇÃO COM PARAMETRO
//function mostrarAnimais
//(animal1,animal2,animal3){
  //  console.log("Esses são meus animais:" + animal1,amimal2,animal3)
//}
//mostrarAnimais("macaco,papagaio")

//function nomedaFuncao(valor){
  //  console.log("Mostra")
//}

//function (guarda_uma_info_que_ainda){
    console.log("Mostra pra mim,qual é o meu valor"+ )
}
//carros()
...
// Após, crie uma estrutura condicional switch que receba esta variável e que possua três casos: caso lasanha,
// retorne no console: “Não vendemos esta comida aqui”. Caso pizza, retorne: “Estamos com escassez de pizza” 
//e caso salada, retorne: “Aqui está, são 3 reais”. Teste com estas três opções e verifique o console do seu navegador. 
...
//let food = "comida"
 ...
 // }
  ...
  let food = "comida"
    ...
    switch (food) {
    case "lasanha":
    console.log("Não temos essa comida aqui")
    break;
